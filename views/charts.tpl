              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-pie pt-4">
                    ...
                    <div id="Submitted" style="display: none;">{{flags_submitted}} </div>
                    <div id="Failed" style="display: none;">{{flags_failed}} </div>
                    <div id="Pending" style="display: none;"> {{flags_pending}}</div>
                  </div>
                  <hr>
